...
- Top-HUD `Tech Tree` button with read-only horizontal technology tree modal (era lanes + dependency links + science summary)
...
- Click `Tech Tree` (next to `Stats`) to open a read-only horizontal science/technology tree
