...
- [spec-005-city-economy-production-and-specialization.md](./spec-005-city-economy-production-and-specialization.md) - Founding, per-owner economy buckets, deterministic queue/building rules, Campus adjacency snapshots, and science-building city outputs.
...
- [spec-007-hud-context-panels-and-notifications.md](./spec-007-hud-context-panels-and-notifications.md) - HUD/context requirements including science-per-turn, turns remaining, boost progress, and city science breakdown visibility.
- [spec-008-ai-personalities-and-strategy.md](./spec-008-ai-personalities-and-strategy.md) - Deterministic multi-faction AI with boost-aware research scoring, science-infrastructure priorities, and visibility-aware strategy.
